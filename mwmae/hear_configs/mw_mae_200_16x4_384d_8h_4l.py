...
def get_config():
    ...
    config.model = ml_collections.ConfigDict()
    config.model.arch = "mw_vit_msm_base_200"
    ...
    config.model.model_args = {
        "patch_size": (4, 16),
        # no need for additional parameters, which were for decoder anyway
    }
...
RUN_ID = 1
model_path = os.path.join(MW_MAE_MODEL_DIR, f"audioset/mw_mae_base_200_16x4_384d-8h-4l_default_8x128_0.8_run{RUN_ID}")
